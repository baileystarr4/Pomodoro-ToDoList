...
class Timer:
    def __init__(self):
        ...
        self.mute_icon = ImageTk.PhotoImage(Image.open("icons/mute_icon.png"))
        ...
        self.unmute_icon = ImageTk.PhotoImage(Image.open("icons/unmute_icon.png"))
    ...
    def clicked_reset_button(self, reset_alert = True):
        ...
        # Reset defaults and pause / play button
        self.reps = 1
        self.total_pomos = 5
        self.work_min = 25
        self.short_break_min = 5
